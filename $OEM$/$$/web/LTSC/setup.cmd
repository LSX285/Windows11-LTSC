...
:: Note - Install Apps
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\DesktopAppInstaller.msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Xaml.2.7.appx'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Xaml.2.8.appx'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\WindowsAppRuntime_1.1.msix'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Services_Store.Engagement.Appx'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Microsoft_Store.Msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Microsoft_Store-PurchaseApp.Msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Nanazip.Msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Notepad.msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\SnippingTool.msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\Windows_Terminal.Msixbundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\XboxIdentityProvider.AppxBundle'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\HEIFIExtension.appx'" >nul 2>&1
PowerShell -ExecutionPolicy Unrestricted -Command "add-appxpackage -path 'C:\Windows\Web\LTSC\Apps\HEVCVideoExtensions.appx'" >nul 2>&1
...
:: Note - Preconfigured Terminal
move /y "C:\Windows\web\LTSC\AdditionalFiles\Terminal\settings.json" "C:\Users\%USERNAME%\AppData\Local\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState" >nul 2>&1
attrib -r C:\Users\%USERNAME%\AppData\Local\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState\settings.json >nul 2>&1
