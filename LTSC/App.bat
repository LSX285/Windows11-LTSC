...
powershell -command "(New-Object Net.WebClient).DownloadFile('https://github.com/LSX285/windows11-ltsc-assets/raw/main/Microsoft_Store.msix', 'C:\Users\%USERNAME%\Desktop\Microsoft_Store.msix')" >nul 2>&1
